...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '}' +
      '.dedup-stats-bar .wins { background: #75bf33; }' +
      '.dedup-stats-bar .draws { background: rgba(128,128,128,0.3); }' +
      '.dedup-stats-bar .losses { background: #e9af6b; }' +
      ...
      '}' +
      '.dedup-stats-table .dot.wins { background: #75bf33; }' +
      '.dedup-stats-table .dot.draws { background: rgba(128,128,128,0.5); }' +
      '.dedup-stats-table .dot.losses { background: #e9af6b; }' +
